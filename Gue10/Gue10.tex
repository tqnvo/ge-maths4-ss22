...
\begin{itemize}
	\item[\checkmark] Programming exercise 02: Explanation.
	      ...
	      %   \end{itemize}
	\item[\checkmark] [Answer to question] Insight review: Example 3 $\cdot$ Gue08
	\item[\checkmark] Euler scheme
	      ...
	      $
	\item[\checkmark] [Remark of Homework 10] Consistency error
\end{itemize}
...
%------------------------------------------------------------------------------
\newpage
\section{Insight review: Example 3 $\cdot$ Gue08}
\begin{example}
