\begin{figure}[ht!]
	...
	\includegraphics[width=0.85\textwidth]{fixedCentral_variatedEpsilon.eps}
	\caption{Comparison among different values of $\varepsilon = [1, 10^{-1}, 10^{-2}, 10^{-4}]$:
	Central difference used for discretizing convection terms $\partial_{x}u$ and $\partial_{y}u$;
	fixed $\beta = 5\pi/6$.}
	\label{\LABEL}
\end{figure}